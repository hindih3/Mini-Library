...
public:
    ...
    public:
        ...
        explicit const_iterator(const iterator& it) noexcept : m_ptr(it.operator->()) {}
    ...
    void insert(size_t index, const T& value) {
        ...
        if constexpr (std::is_trivially_copyable_v<T>) {
            ...
            mini::construct<T>(m_data + index, value);
        }
    ...
    void insert(size_t index, T&& value) {
        ...
        if constexpr (std::is_trivially_copyable_v<T>) {
            ...
            mini::construct<T>(m_data + index, std::move(value));
        }
        ++m_size;
    }
